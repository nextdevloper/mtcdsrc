...
/**
 * 組織所属マスタ	 組織情報に所属するアカウントを定義する。.
 *
 * @author  nakada
 * @since   XXXXXXXX.01.00
 * @version 20141029.00.01
 */
@Entity(listener = MRStrctaccListener.class)
@Table(name = "m_r_strctacc")
public class MRStrctacc {
    ...
    /**
     * Returns the adminFlg.
     *
     * @return the adminFlg
     */
    public final String getAdminFlg() {
        return adminFlg;
    }
     ...
     * Sets the adminFlg.
     *
     * @param prmAdminFlg the adminFlg
     */
    public final void setAdminFlg(final String prmAdminFlg) {
        this.adminFlg = prmAdminFlg;
    }
