...
/**
 * メッセージ送信履歴（お知らせ）	 お知らせメッセージの送信履歴.
 *
 * @author  nakada
 * @since   XXXXXXXX.01.00
 * @version 20141029.00.01
 */
@Entity(listener = TMsgSendNewsListener.class)
@Table(name = "t_msg_send_news")
public class TMsgSendNews {
	...
	@SequenceGenerator(sequence = "mtcddb.t_msg_send_news_msg_no_seq")
    @Column(name = "msg_no")
    private Long msgNo;
