...
/**
 * メッセージ送信履歴（結果報告）	 結果報告メッセージの送信履歴.
 *
 * @author  nakada
 * @since   XXXXXXXX.01.00
 * @version 20141029.00.01
 */
@Entity(listener = TMsgSendResultListener.class)
@Table(name = "t_msg_send_result")
public class TMsgSendResult {
	...
	@SequenceGenerator(sequence = "mtcddb.t_msg_send_result_msg_no_seq")
    @Column(name = "msg_no")
    private Long msgNo;
