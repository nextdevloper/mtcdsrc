...
<%-- 詳細画面 --%>
		<div id="B1" style="display:${f:h(boxDetailDisplay)};">
			<h2>ボックス詳細</h2>
			ロケーション名：${f:h(locNm)}（ID:${f:h(locId)}/${f:h(locKindStr)}）
			<div class="fakelist" align="left">
				<a href="#" onclick="document.getElementById('B1').style.display = 'none'; document.getElementById('B2').style.display = 'block';">ボックス編集</a>
			</div>
			<table class="table">
				<tr>
...
<%-- 更新登録確認画面 --%>
		<div id="B3" style="display:${f:h(boxConfirmDisplay)};">
			<h2>ボックス登録変更</h2>
			<table class="table">
				<tr>
