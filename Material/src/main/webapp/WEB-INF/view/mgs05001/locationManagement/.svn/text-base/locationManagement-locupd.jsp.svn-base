...
<%-- 詳細画面 --%>
		<div id="L1" style="display:${f:h(locDetailDisplay)};">
			<h2>ロケーション詳細</h2>
			<div class="fakelist" align="left">
				<a href="#" onclick="document.getElementById('L1').style.display = 'none'; document.getElementById('L2').style.display = 'block';">ロケーション編集</a>
			</div>
			<table class="table">
				<tr>
		...
		<div id="L2" style="display:${f:h(locUpdDisplay)};">
			...
			<table class="table">
				<tr>
					...
					<td>
						${f:h(locId)}
						<html:checkbox styleId="checkbox" property="locKind" value="${f:h(locKindDef)}" /><font size="1" color="blue">公開</font>
					</td>
				</tr>
				<tr>
...
<%-- 更新登録確認画面 --%>
		<div id="L3" style="display:${f:h(locConfirmDisplay)};">
			<h2>ロケーション登録変更</h2>
			<table class="table">
				<tr>
					<td class="tb">ロケーション情報</td>
			...
			<s:submit property="locUpdReg" value="確認" />
		</div>
